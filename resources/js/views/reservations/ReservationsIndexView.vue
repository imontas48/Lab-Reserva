  ...
  <div class="space-y-6">
    ...
    <div v-if="loading && reservations.length === 0" class="flex items-center justify-center py-12">
      <div class="text-center">
        ...
        <p class="mt-4 text-sm text-gray-600">Cargando tus reservas...</p>
      </div>
    </div>
    ...
    <!-- Empty State -->
    <div v-else-if="reservations.length === 0" class="rounded-lg border-2 border-dashed border-gray-300 p-12 text-center">
      <svg class="mx-auto h-12 w-12 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z"/>
      </svg>
      <h3 class="mt-4 text-lg font-medium text-gray-900">No tienes reservas</h3>
      <p class="mt-2 text-sm text-gray-500">Comienza creando tu primera reserva de equipo</p>
      <router-link
        to="/reservations/create"
      ...
      <div class="grid gap-4 sm:grid-cols-1 lg:grid-cols-2">
        ...
        >
          ...
          <div class="mb-4 flex items-start justify-between">
            <span
              :class="{
                'bg-green-100 text-green-800': reservation.is_future,
                'bg-blue-100 text-blue-800': reservation.is_active,
          ...
          <div class="space-y-2 border-t border-gray-200 pt-4">
            ...
            <div class="flex items-center text-sm text-gray-700">
              ...
              <span class="ml-2 text-xs text-gray-500">({{ reservation.duration_minutes }} min)</span>
            </div>
          </div>
          ...
          <div v-if="reservation.is_future && reservation.status === 'confirmed'" class="mt-4 flex justify-end">
            <button
              ...
              class="inline-flex items-center rounded-lg border border-red-300 bg-white px-3 py-1.5 text-sm font-medium text-red-700 hover:bg-red-50 focus:outline-none focus:ring-2 focus:ring-red-500 focus:ring-offset-2 disabled:opacity-50"
            >
